...
public class TestEditOrder {
	...
	@Test
	public void testEditOrder1() throws ValidateOrderException, CustomerNotFoundException, AddressNotFoundException, ProductNotFoundException, OrderIdException {
		Order1Dto dto = new Order1Dto(1,"Confirmed",LocalDate.of(2021, 03, 02),1,1,1);
		assertNotNull(orderService.updateOrder(dto));
	}
	
	@Test
	public void testEditOrder2() throws OrderIdException, ValidateOrderException, CustomerNotFoundException, AddressNotFoundException, ProductNotFoundException {
	...
	@Test
	public void testEditOrder3() throws OrderIdException, ValidateOrderException, CustomerNotFoundException, AddressNotFoundException, ProductNotFoundException {
	...
	@Test
	public void testEditOrder4() throws OrderIdException, ValidateOrderException, CustomerNotFoundException, AddressNotFoundException, ProductNotFoundException {
	...
	@Test
	public void testEditOrder5() throws OrderIdException, OrderIdException, ValidateOrderException, CustomerNotFoundException, AddressNotFoundException, ProductNotFoundException {
	...
	@Test
	public void testEditOrder6() throws OrderIdException, ValidateOrderException, CustomerNotFoundException, AddressNotFoundException, ProductNotFoundException {
